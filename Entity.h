enum EntityType { PLATFORM, PLAYER, BALL };
...
public:
    ...
    void accelerate_left() { m_acceleration.x = -2.0f; };
    void accelerate_right() { m_acceleration.x = 2.0f; };
    void accelerate_up() { m_acceleration.y = 3.0f; };

    void set_collided(EntityType collidable) { collided = collidable; }
